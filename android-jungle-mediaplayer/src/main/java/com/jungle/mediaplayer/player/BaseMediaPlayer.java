...
public abstract class BaseMediaPlayer
    ...
    protected MediaMetadataRetriever mMediaMetadataRetriever;
    ...
    public void setPreviewDataSource(VideoInfo videoInfo) {
        try {
            mMediaMetadataRetriever.setDataSource(videoInfo.getStreamUrl(), new HashMap<String, String>());
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
    ...
    public Bitmap getFrameAtTime(long time) {
        Bitmap bitmap = null;
        try {
            bitmap = mMediaMetadataRetriever.getFrameAtTime(time, MediaMetadataRetriever
                    .OPTION_CLOSEST_SYNC);
        } catch (Exception e) {
            e.printStackTrace();
        }
