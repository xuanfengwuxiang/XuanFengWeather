...
import com.xuanfeng.xuanfengweather.module.media.adapter.ViewPagerPhotoAdapter;
...
public class PhotoShowFragment extends BaseFragment {
    ...
    private void setViewPager() {
        ...
        mVpPhoto.setPageTransformer(true, new ZoomOutPageTransformer(getContext()));
    }
    ...
    public int getLayoutId() {
        return R.layout.fragment_material_desgin;
    }
